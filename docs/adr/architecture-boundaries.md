...
## Explicitly Not Decided Yet (TODO: VERIFY)
- Jurisdiction(s) of operation and regulatory posture
- KYC/AML requirements and identity proofing provider(s)
- Custodial vs non-custodial wallet/payment model
- Escrow dispute resolution workflow and legal terms
- Currency support, FX handling, and settlement windows
- Message encryption model (server-visible vs end-to-end encrypted)
- DID method(s), key rotation policy, and recovery flows
- Marketplace fraud controls, moderation, and sanctions screening
